...
INSERT INTO user_account (password,username,autoridad) VALUES ('alicia','alicia','2');
...
INSERT INTO user_account (password,username,autoridad) VALUES ('alvaro','alvaro','1');
...
INSERT INTO asignatura_grados (asignatura_id, grados) VALUES ('9', '7');
INSERT INTO asignatura_grados (asignatura_id, grados) VALUES ('10', '8');
INSERT INTO asignatura_grados (asignatura_id, grados) VALUES ('11', '8');
INSERT INTO asignatura_grados (asignatura_id, grados) VALUES ('12', '9');
INSERT INTO asignatura_grados (asignatura_id, grados) VALUES ('13', '10');
INSERT INTO asignatura_grados (asignatura_id, grados) VALUES ('14', '11');
INSERT INTO asignatura_grados (asignatura_id, grados) VALUES ('15', '12');
...
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Rojas', 'Gutierrez','07575994R', 'rodrojgut@alum.us.es', 'Rodrigo', '123456789',  '7', false, 2,null,true);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Carillo', 'Mirando', '85694759W','fcarmir@gmail.com', 'Fernando','652314129',  '8', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,valoracion_media,derecho_olvidado) VALUES ('Cano', 'Caldero', '15001711F','alejandrocano.caldero@gmail.com', 'Alejandro','123426719', '12', false, 2,null,5,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Cantero', 'Garcia', '99619865B','martacanterogarcia@gmail.com', 'Marta', '127656283','13', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Meca', 'Sanchez', '86658574W','andmecsan@alum.us.es', 'Andrea', '695073140','14',false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Jimenez', 'Soldado', '51464215J','frajimsol@alum.us.es', 'Franciso Javier','695073199', '16', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Montes', 'Saborido', '76414260A','eduardo@gmail.com', 'Eduardo', '695073369', '18', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Humanes', 'Garcia', '52951685G','davidtenis1@gmail.com', 'David', '695074189', '20', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Bueno', 'Molina', '31246570N','rcbuenomolina@gmail.com', 'Rocio', '695014169', '22', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Guerrero', 'Fischer', '20922692Y','paulaguerrerofischer@gmail.com', 'Paula', '695014129', '24', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Del Valle', 'Lopez de Santa Maria', '72338268W','javo13697@gmail.com', 'Javier', '652314129', '26', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Aguado', 'Delgado', '45247283G','saraaguadodelgado@gmail.com', 'Sara', '643135129', '29', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Bay', 'Bay', '62383749K','miriam.bay@gmail.com', 'Miriam', '643132547',  '31', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Gonzales de la Peña', 'Garcia', '15054975A','marioogonzalez2@gmail.com', 'Mario', '643831247','33', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Jesus Sanchez', 'Cruz-Sagredo', '02030477Z','juanje_chus@gmail.com', 'Juan', '678886247', '35', false, 2,null,false);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, useraccount_id,tarifa_premium,expediente_validado,fecha_pago_premium,derecho_olvidado) VALUES ('Ruiz', 'Castilla', '98543603B','carmenrucasti@gmail.com', 'Carmen', '623816657', '37', false, 2,null,false);


INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Montes', 'Saborido','0', '04656520D', 'alicia@gmail.com', 'Alicia', '123456722','1', '1', '1', '2',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Rojas', 'Gutierrez','0', '07575994R', 'rodrojgut@alum.us.es', 'Rodrigo', '123456789', '4', '5', '1','3',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Romero', 'Caceres','0', '39845718N', 'anaromcac@alum.us.es', 'Ana', '603552740','1', '1', '1',  '4',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Squen', 'Saavedra','0', '90122321H', 'lizesqsaa@alum.us.es', 'Lizseth Katherine', '653552740','1', '3', '1',  '9',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Lobato', 'Troncoso','0', '35561913A', 'josema_6497@alum.us.es', 'Jose Manuel', '603554740', '1', '4', '1', '10',true);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Mauri', 'Mitchell','0', '56136756N', 'crimaumit@alum.us.es', 'Cristina Maria', '695073170','1', '3', '1', '11',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Meca', 'Sanchez','0', '86658574W', 'andmecsan@alum.us.es', 'Andrea', '695073140', '1', '1', '1','15',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Jimenez', 'Soldado','0', '51464215J', 'frajimsol@alum.us.es', 'Franciso Javier', '695073199','1', '3', '1', '17',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Montes', 'Saborido','0', '76414260A', 'eduardo@gmail.com', 'Eduardo', '695073369','1', '3', '1', '19',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Humanes', 'Garcia','0', '52951685G', 'davidtenis1@gmail.com', 'David', '695074189', '1', '1', '1','21',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Bueno', 'Molina','0', '31246570N', 'rcbuenomolina@gmail.com', 'Rocio', '695014169', '1', '1', '1', '23',false);
INSERT INTO alumno (apellido1, apellido2, contador_descuento, dni, email, nombre, telefono,facultad_nombre, grado_nombre, universidad_nombre, useraccount_id,derecho_olvidado) VALUES ('Guerrero', 'Fischer','0', '20922692Y', 'paulaguerrerofischer@gmail.com', 'Paula', '695014129', '1', '2', '1','25',false);
...
INSERT INTO valoracion (profesor_id, alumno_id,espacio_id,puntuacion,comentario) VALUES ('5', '3','5', 5,'Gracias a él he aprobado');
