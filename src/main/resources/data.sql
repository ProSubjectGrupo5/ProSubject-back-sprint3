...
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Rojas', 'Cantos','86800079B','alvaro@gmail.com', 'Alvaro','123436385', '5', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Romero ', 'Organvidez','86558252Y','drorganvidez@gmail.com', 'David', '123436485', '6', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Rojas', 'Gutierrez','07575994R', 'rodrojgut@alum.us.es', 'Rodrigo', '123456789',  '7', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Carillo', 'Mirando', '85694759W','fcarmir@gmail.com', 'Fernando','652314129',  '8', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Cano', 'Caldero', '15001711F','alejandrocano.caldero@gmail.com', 'Alejandro','123426719', '12', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Cantero', 'Garcia', '99619865B','martacanterogarcia@gmail.com', 'Marta', '127656283','13', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Meca', 'Sanchez', '86658574W','andmecsan@alum.us.es', 'Andrea', '695073140','14',false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Jimenez', 'Soldado', '51464215J','frajimsol@alum.us.es', 'Franciso Javier','695073199', '16', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Montes', 'Saborido', '76414260A','eduardo@gmail.com', 'Eduardo', '695073369', '18', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Humanes', 'Garcia', '52951685G','davidtenis1@gmail.com', 'David', '695074189', '20', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Bueno', 'Molina', '31246570N','rcbuenomolina@gmail.com', 'Rocio', '695014169', '22', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Guerrero', 'Fischer', '20922692Y','paulaguerrerofischer@gmail.com', 'Paula', '695014129', '24', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Del Valle', 'Lopez de Santa Maria', '72338268W','javo13697@gmail.com', 'Javier', '652314129', '26', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Aguado', 'Delgado', '45247283G','saraaguadodelgado@gmail.com', 'Sara', '643135129', '29', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Bay', 'Bay', '62383749K','miriam.bay@gmail.com', 'Miriam', '643132547',  '31', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Gonzales de la Peña', 'Garcia', '15054975A','marioogonzalez2@gmail.com', 'Mario', '643831247','33', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Jesus Sanchez', 'Cruz-Sagredo', '02030477Z','juanje_chus@gmail.com', 'Juan', '678886247', '35', false, 2);
INSERT INTO profesor (apellido1, apellido2, dni, email, nombre, telefono, user_account_id,tarifa_premium,expediente_validado) VALUES ('Ruiz', 'Castilla', '98543603B','carmenrucasti@gmail.com', 'Carmen', '623816657', '37', false, 2);


INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Montes', 'Saborido', '04656520D', 'alicia@gmail.com', 'Alicia', '123456722', '2');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Rojas', 'Gutierrez', '07575994R', 'rodrojgut@alum.us.es', 'Rodrigo', '123456789', '3');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Romero', 'Caceres', '39845718N', 'anaromcac@alum.us.es', 'Ana', '603552740', '4');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Squen', 'Saavedra', '90122321H', 'lizesqsaa@alum.us.es', 'Lizseth Katherine', '653552740', '9');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Lobato', 'Troncoso', '35561913A', 'josema_6497@alum.us.es', 'Jose Manuel', '603554740', '10');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Mauri', 'Mitchell', '35561913A', 'crimaumit@alum.us.es', 'Cristina Maria', '695073170', '11');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Meca', 'Sanchez', '86658574W', 'andmecsan@alum.us.es', 'Andrea', '695073140', '15');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Jimenez', 'Soldado', '51464215J', 'frajimsol@alum.us.es', 'Franciso Javier', '695073199', '17');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Montes', 'Saborido', '76414260A', 'eduardo@gmail.com', 'Eduardo', '695073369', '19');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Humanes', 'Garcia', '52951685G', 'davidtenis1@gmail.com', 'David', '695074189', '21');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Bueno', 'Molina', '31246570N', 'rcbuenomolina@gmail.com', 'Rocio', '695014169', '23');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Guerrero', 'Fischer', '20922692Y', 'paulaguerrerofischer@gmail.com', 'Paula', '695014129', '25');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Del Valle', 'Lopez de Santa Maria', '72338268W', 'javo13697@gmail.com', 'Javier', '652314129', '27');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Carillo', 'Mirando', '85694759W', 'fcarmir@gmail.com', 'Fernando', '652314129', '28');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Aguado', 'Delgado', '45247283G', 'saraaguadodelgado@gmail.com', 'Sara', '643135129', '30');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Bay', '', '62383749K', 'miriam.bay@gmail.com', 'Miriam', '643132547', '32');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Gonzales de la Peña', 'Garcia', '15054975A', 'marioogonzalez2@gmail.com', 'Mario', '643831247', '34');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Jesus Sanchez', 'Cruz-Sagredo', '02030477Z', 'juanje_chus@gmail.com', 'Mario', '678886247', '36');
INSERT INTO alumno (apellido1, apellido2, dni, email, nombre, telefono, user_account_id) VALUES ('Ruiz', 'Castilla', '98543603B', 'carmenrucasti@gmail.com', 'Carmen', '623816657', '38');
