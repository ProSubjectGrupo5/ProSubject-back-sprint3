...
public class GenerarPdf {
    ...
    public static ByteArrayInputStream citiesReport(List<Alumno> cities) {
        ...
        try {
            ...
            hcell = new PdfPCell(new Phrase("Grado", headFont));
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(hcell);


            for (Alumno city : cities) {
                ...
                cell = new PdfPCell(new Phrase(city.getNombre()));
                cell.setPaddingLeft(5);
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
                cell.setHorizontalAlignment(Element.ALIGN_LEFT);
                table.addCell(cell);

                cell = new PdfPCell(new Phrase(String.valueOf(city.getEmail())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
